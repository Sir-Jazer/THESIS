<x-guest-layout>
    <form method="POST" action="{{ route('register.irregular.step1.store') }}" class="space-y-4">
        @csrf

        <h2 class="text-lg font-semibold text-gray-900">Irregular Student Registration (Step 1 of 2)</h2>
        ...
        <div class="flex items-center justify-between">
            ...
            <x-primary-button>{{ __('Continue to Step 2') }}</x-primary-button>
        </div>
    </form>
</x-guest-layout>
